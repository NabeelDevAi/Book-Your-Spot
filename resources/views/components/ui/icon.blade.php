...
@php
    $paths = [
        ...
        'video'         => '<rect x="2.5" y="5" width="11" height="10" rx="2"/><path d="M13.5 8.5 17.5 6v8l-4-2.5Z"/>',
        ...
        'download'      => '<path d="M10 3v10.5m0 0-3.75-3.75M10 13.5l3.75-3.75M3.5 15.5V16a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-.5"/>',
    ];
